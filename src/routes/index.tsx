  ...
  return (
    <main>
      <section className="blueprint">
        <div className="mx-auto grid max-w-[1440px] grid-cols-12 gap-8 px-5 py-12 sm:px-8 sm:py-16 lg:py-24">
      ...
      <section className="blueprint-light text-brand-ink">
        <div className="mx-auto grid max-w-[1440px] grid-cols-12 gap-8 px-5 py-16 sm:px-8 sm:py-20">
      ...
      <section className="bg-brand-ink-2"><div className="mx-auto grid max-w-[1440px] grid-cols-12 items-start gap-8 px-5 py-16 sm:items-end sm:px-8 sm:py-20"><div className="col-span-12 lg:col-span-7"><p className="text-[11px] uppercase tracking-[0.3em] text-brand-paper/50">04 — Start a project</p><h2 className="mt-4 max-w-[18ch] text-3xl leading-tight sm:mt-5 sm:text-4xl lg:text-5xl">Send us the problem. We’ll shape the path forward.</h2></div><div className="col-span-12 lg:col-span-5"><Link to="/contact" className="flex w-full items-center justify-between bg-brand-orange px-6 py-4 font-semibold text-brand-ink">Contact R2 DreamForge <span>→</span></Link><p className="mt-3 text-sm text-brand-paper/50">Tell us your goal, current systems, and ideal timeline.</p></div></div></section>
    </main>
  );
}
